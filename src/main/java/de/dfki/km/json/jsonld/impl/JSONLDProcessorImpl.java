...
public class JSONLDProcessorImpl implements
    ...
    private Object expand(Map<String,Object> ctx, Object property,
                          Object value) {
        Object rval = null;
        if (value == null) {
            return null;
            ...
            // do type coercion
            String coerce = JSONLDUtils.getCoercionType(ctx, (String)property);//, null);
    ...
    public Object compact(Map<String, Object> ctx, Object property, Object value, Map<String,Object> usedCtx) {
        ...
        if (value == null) {
            ...
            ((Map<String, Object>) rval).put(
                                             keywords.get("@id"), 
                                             compact(ctx, property, ((Map) value).get("@id"), usedCtx));

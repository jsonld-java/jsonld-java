...
public class TurtleRegexTests {
	...
	public void test_BASE() {
		Matcher matcher = Regex.BASE.matcher("@base <http://www.google.com/test#> .");
		assertTrue(matcher.matches());
	...
	public void test_SPARQL_BASE() {
		Matcher matcher = Regex.SPARQL_BASE.matcher("BaSe <http://www.google.com/test#>");
		assertTrue(matcher.matches());
		assertEquals(1, matcher.groupCount());
		assertNotNull(matcher.group(1));
		assertEquals("http://www.google.com/test#", matcher.group(1));
	...
	public void test_STRING() {
		assertTrue(
				"\"dffhjkasdhfskldhfoiw'eu\\\"fhowleifh\u00F8\u02FF\u0370\u037D\"".matches("^" + Regex.STRING + "$")
				);
		assertFalse(
				"\"dffhjkasdhfs\nkldhfoiw\\\"'eufhowleifh \u00F8\u02FF\u0370\u037D\"".matches("^" + Regex.STRING + "$")
				);
		assertTrue(
				"'dffhjkasdhfskldh\\'foiweu\"fhowleifh \u00F8\u02FF\u0370\u037D'".matches("^" + Regex.STRING + "$")
				);
		assertFalse(
				"\"dffhjkasdhfs\nkldhfoiw\\\"'eufhowleifh \u00F8\u02FF\u0370\u037D\"".matches("^" + Regex.STRING + "$")
				);
		assertTrue(
				"'''dffhjkasdhfsk\nldhfoiw\"'eufhowleifh \u00F8\u02FF\u0370\u037D'''".matches("^" + Regex.STRING + "$")
				);
		assertTrue(
				"\"\"\"dffhjkasdhfsk\nldhfoiw\"'eufhowleifh \u00F8\u02FF\u0370\u037D\"\"\"".matches("^" + Regex.STRING + "$")
				);
	...
	public void test_BOOLEAN_LITERAL() {
		assertTrue(
				"true".matches("^" + Regex.BOOLEAN_LITERAL + "$")
				);
		assertTrue(
				"false".matches("^" + Regex.BOOLEAN_LITERAL + "$")
				);
	}
	@Test
	...
	public void test_SUBJECT() {
		...
		// a subject match without any matching groups should == an anonymous subject

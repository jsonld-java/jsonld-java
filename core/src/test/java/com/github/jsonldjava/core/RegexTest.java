...
public class RegexTest {
	...
	public void test_TRICKY_UTF_CHARS() throws IOException {
		...
		for (int i = 0x10000; i <= 0xeffff; i++) {
			...
			String test = Character.toString(u1[0]) + Character.toString(u1[1]);// + Character.toString(u2[0]) + Character.toString(u2[1]);
			...
			//}
			assertTrue(
					test.matches("" + Regex.TRICKY_UTF_CHARS + "")
			);
		}
	}
	...
	public void test_PN_CHARS_BASE() throws IOException {
		...
		assertTrue(
				test.matches("^(?:" + Regex.PN_CHARS_BASE + ")+$")
		);
		assertFalse(
				"_".matches("^" + Regex.PN_CHARS_BASE + "$")
		);
	}
	@Test
	...
	public void test_PN_PREFIX() {
		...
		assertTrue(
				testT.matches("^" + Regex.PN_PREFIX + "$")
				);
		assertFalse(
				testF.matches("^" + Regex.PN_PREFIX + "$")
				);
		assertFalse(
				"_:b".matches("^" + Regex.PN_PREFIX + "$")
				);	
	}
	@Test
	public void test_HEX() {
		assertTrue(
				"0123456789ABCDEFabcdef".matches("^" + Regex.HEX + "+$")
				);
		assertFalse(
				"0123456789ABCDEFabcdefg".matches("^" + Regex.HEX + "+$")
				);
	}
	@Test
	public void test_PN_LOCAL_ESC() {
		assertTrue(
				"\\&\\!\\_\\~".matches("^(?:" + Regex.PN_LOCAL_ESC + ")+$")
				);
	}
	@Test
	public void test_PERCENT() {
		assertTrue(
				"%A0".matches("^" + Regex.PERCENT + "$")
				);
	}
	@Test
	public void test_PLX() {
		assertTrue(
				"%A0".matches("^" + Regex.PLX + "$")
				);
		assertTrue(
				"\\&\\!\\_\\~%A0".matches("^(?:" + Regex.PLX + ")+$")
				);
	}
	@Test
	public void test_PN_LOCAL() {
		assertTrue(
				":abcdef.:%FF\\#".matches("^" + Regex.PN_LOCAL + "$")
				);
	}
	@Test
	public void test_PNAME_NS() {
		assertTrue(
				":".matches("^" + Regex.PNAME_NS + "$")
				);
		assertTrue(
				"abc:".matches("^" + Regex.PNAME_NS + "$")
				);
		assertTrue(
				"\u00F8\u02FF\u0370\u037D:".matches("^" + Regex.PNAME_NS + "$")
				);
	}
	@Test
	public void test_PNAME_LN() {
		assertTrue(
				":p".matches("^" + Regex.PNAME_LN + "$")
				);
		assertTrue(
				"abc:def".matches("^" + Regex.PNAME_LN + "$")
				);
		assertTrue(
				"\u00F8\u02FF\u0370\u037D:\u00F8\u02FF\u0370\u037D".matches("^" + Regex.PNAME_LN + "$")
				);
	}
	@Test
	public void test_UCHAR() {
		assertTrue(
				"\\u0ABC".matches("^" + Regex.UCHAR + "$")
				);
		assertTrue(
				"\\U0123ABCD".matches("^" + Regex.UCHAR + "$")
				);
	}
	@Test
	...
	public void test_BLANK_NODE_LABEL() {
		assertTrue(
				"_:abcd".matches("^" + Regex.BLANK_NODE_LABEL + "$")
				);
		assertTrue(
				"_:abcd\u007A".matches("^" + Regex.BLANK_NODE_LABEL + "$")
				);
		assertTrue(
				"_:\u00C0\u0041\u005A\u0061\u007A".matches("^" + Regex.BLANK_NODE_LABEL + "$")
				);
		assertTrue(
				"_:abcd\u00C0".matches("^" + Regex.BLANK_NODE_LABEL + "$")
				);
	...
	public void test_STRING_LITERAL_QUOTE() {
		...
		assertTrue(
				"\"dffhjkasdhfskldhfoiw'eu\\\"fhowleifh \u00F8\u02FF\u0370\u037D\"".matches("^" + Regex.STRING_LITERAL_QUOTE + "$")
				);
		assertFalse(
	...
	public void test_STRING_LITERAL_SINGLE_QUOTE() {
		assertTrue( 
				"'dffhjkasdhfskldhf\\'oiweu\"fhowleifh \u00F8\u02FF\u0370\u037D'".matches("^" + Regex.STRING_LITERAL_SINGLE_QUOTE + "$")
				);
		assertFalse(
	...
	public void test_LANGTAG() {
		assertTrue(
				"@en".matches("^" + Regex.LANGTAG + "$")
				);
		assertTrue(
				"@abc-def".matches("^" + Regex.LANGTAG + "$")
				);
	}
	...
	public void test_unescape() {
		...
		r = RDFDatasetUtils.unescape("http://a.example/AZaz\u00c0\u00d6\u00d8\u00f6\u00f8\u02ff\u0370\u037d\u0384\u1ffe\u200c\u200d\u2070\u2189\u2c00\u2fd5\u3001\ud7fb\ufa0e\ufdc7\ufdf0\uffef");
		assertTrue("http://a.example/AZaz\u00c0\u00d6\u00d8\u00f6\u00f8\u02ff\u0370\u037d\u0384\u1ffe\u200c\u200d\u2070\u2189\u2c00\u2fd5\u3001\ud7fb\ufa0e\ufdc7\ufdf0\uffef".equals(r));
		
		r = RDFDatasetUtils.unescape("http://a.example/AZaz\\u00c0\\u00d6\\u00d8\\u00f6\\u00f8\\u02ff\\u0370\\u037d\\u0384\\u1ffe\\u200c\\u200d\\u2070\\u2189\\u2c00\\u2fd5\\u3001\\ud7fb\\ufa0e\\ufdc7\\ufdf0\\uffef\\U00010000\\U000e01ef");
		assertTrue("http://a.example/AZaz\u00c0\u00d6\u00d8\u00f6\u00f8\u02ff\u0370\u037d\u0384\u1ffe\u200c\u200d\u2070\u2189\u2c00\u2fd5\u3001\ud7fb\ufa0e\ufdc7\ufdf0\uffef\uD800\uDC00\uDB40\uDDEF".equals(r));
	}
}

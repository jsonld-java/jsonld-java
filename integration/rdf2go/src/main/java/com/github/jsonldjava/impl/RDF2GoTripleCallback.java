...
/**
 * Implementation of {@link JSONLDTripleCallback} which serializes JSONLD datasets
 * into a {@link ModelSet} object.
 * 
...
public class RDF2GoTripleCallback implements JSONLDTripleCallback {
	...
	private void triple(Resource subject, URI predicate, Node object, String graph) {
		URI context = graph == null ? null : sinkModel.createURI(graph);
